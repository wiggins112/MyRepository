package vip.bizhihui.app.module.component;
...
import com.eros.framework.extend.comoponents.BMChart;
...
public class BZHWeb  extends WXComponent implements IWebView.OnPageListener {
    ...
    public BZHWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, int type) {
        super(instance, dom, parent, type);
        init();
    }

    public BZHWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String
        instanceId, boolean isLazy) {
        super(instance, dom, parent, instanceId, isLazy);
        init();
    }

    public BZHWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
        super(instance, dom, parent, isLazy);
        init();
    }

    public BZHWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent) {
