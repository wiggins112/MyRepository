...
typedef NS_ENUM(NSInteger,BMSharePlatformType) {
    ...
    BMSharePlatformType_Facebook,
    BMSharePlatformType_FacebookMessage,
    BMSharePlatformType_WhatsApp,
    BMSharePlatformType_Line,
    BMSharePlatformType_Twitter
};

#define K_SharePlatformSina                 @"SinaWeibo"
...
#define K_SharePlatformFacebookMessage      @"FacebookMessage"
#define K_SharePlatformWhatsApp             @"WhatsApp"
#define K_SharePlatformLine                 @"Line"
...
@property (nonatomic, copy) NSString *imageType;                /**< 分享的图片类型 */
